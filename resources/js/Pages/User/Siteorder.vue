    ...
    <Layouts>
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <!-- elementui eldialog -->
                <el-dialog v-model="dialogVisible" :title="editMode ? '编辑网站代购订单' : '提交网站代购订单'" width="30%"
                    ...
                    <form @submit.prevent="editMode ? updateProduct() : AddProduct()" class="max-w-md mx-auto">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input v-model="site" type="text" name="floating_site" id="floating_site"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            <label for="floating_site"
                                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                网址</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <label for="description"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">其他说明</label>
                                ...
                                <tr v-for="siteorder in siteorders" :key="siteorder.id"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div :id="`${siteorder.id}`"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                :aria-labelledby="`${siteorder.id}-button`">

                                                <li>
                                                    <a href="#" @click="openEditModal(siteorder)"
                                                        class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                        Edit</a>
                                                </li>
                                            </ul>
